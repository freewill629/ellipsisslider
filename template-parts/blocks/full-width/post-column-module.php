...
$acf_header_background_color = get_field('header_background_color');
$acf_count_background_color = get_field('count_background_color');
$acf_custom_button_link = get_field('custom_button_link');
            ...
            <div class="two-column-module__row">
                <div class="row justify-content-center">
                    ...
                    foreach ($posts as $post) {
                        ...
                        $acf_redirection_url = get_field('redirection_url', $post->ID);
                    ?>
                            ...
                            <div class="two-column-module__box">
                                ...
                                <?php if (isset($acf_display_post_header_option) && $acf_display_post_header_option == "header"): ?>
                                    <div class="post_iconWithcircle_Box">
                                        <div class="post_iconBox" style="background-color: <?php echo  $acf_header_background_color; ?>">
                                            <h3 class="post_iconBox_heading"><?php echo $courses_heading ? $courses_heading  : get_the_title($post->ID); ?></h3>
                                        </div>
                                        <div class="post_iconCircle" style="background-color: <?php echo  $acf_count_background_color; ?>"> <?php echo $courses_count ? $courses_count : 'MS' ?> </div>
                                    </div>
                                <?php else :  ?>
                                ...
                                <div class="two-column-module__button">
                                    <?php $url = $acf_custom_button_link === 'yes' ? $acf_redirection_url : get_permalink($post->ID); ?>
                                    <a href="<?php echo $url ? $url : get_permalink($post->ID); ?>" class="orangebtn orangebtn--solid orangebtn--medium-small">
                                        <?php
                    ...
                    ?>
                        ...
                        <div class="col-lg-4">
                            <div class="three-column-module__col">
                                ...
                                <div class="three-column-module__btn">
                    ...
                    foreach ($posts as $post) :
                        ...
                        <div class="col-lg-3">
                            <div class="four-column-computer-science__col">
                                ...
                                <?php if ($button) : ?>
                                    <div class="four-column-computer-science__btn">
                                        <?php $url = $acf_custom_button_link === 'yes' ? $acf_redirection_url : get_permalink($post->ID); ?>
                                        <a href="<?php echo $url ? $url : get_permalink($post->ID); ?>" class="orangebtn orangebtn--solid orangebtn--medium-small">
                                            <?php
                                            if (get_post_meta($post->ID, 'permalink-btn', true)) :
