    ...
    <div class="page-container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-10">
                ...
                <?php endif; ?>
                <?php if(!empty($acf_media_image)) : ?>
                    <?php if ($acf_media_option == 'image') : ?>
                        <img src="<?php echo $acf_media_image; ?>" class="img-fluid"> 
                    <?php endif; ?>
                <?php endif; ?>    
                <?php if ($acf_media_option == 'video') : ?>
                    <?php echo $acf_media_video; ?>
                <?php endif; ?> 
