...
module.exports = {
    ...
    entry: {
        ...
        // Full Width
        acf_hero_banner: path.resolve(__dirname, "src/components/template-parts/blocks/full-width/hero-banner/index"),
        acf_text_with_media: path.resolve(__dirname, "src/components/template-parts/blocks/full-width/text-with-media/index"),
        acf_text_with_icons: path.resolve(__dirname, "src/components/template-parts/blocks/full-width/text-with-icons/index"),
    },
