        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-9">
                <div class="inner_grid">
                    ...
                    <p>Codelicious provides comprehensive curricula with resources that will enable educators to
                        effectively integrate high-quality computer science instruction in grades K-12.</p>

                    <div class="cta-with-navigation__links">
                        <p>Learn more about Codelicious Computer Science Curriculum:
                        </p>
                        <ul>
                            <li><a href="#"> What is Codelicious?</a></li>
