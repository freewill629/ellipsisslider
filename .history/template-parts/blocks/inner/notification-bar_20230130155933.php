...
<section class="text-with-media" style="background-image: url(./images/notification-bar-bg.png);">
    <div class="page-container box-padding">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-9">
                <h3 class="center-heading color-white">
                    Learn More About Codelicious
                </h3>
                <div class="text-with-media__descreption">
                    <p style="text-align: center;">Explore <a href="#">career opportunities</a>, read about <a href="#">awards</a> received by the
                        curriculum, and find us in
                        the news. You can also follow us on social media by clicking the icons below!
                    </p>
                </div>
