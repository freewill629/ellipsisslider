        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-9">
                <div class="center-module border-bottom">
                    <img src="./images/codelicious-mark-sm.png">
                    <h6 class="center-heading color-white">
                        K-12 Computer Science Courses
                    </h6>
                    <p style="margin-bottom: 0;">Codelicious Computer Science Curriculum is grade-level differentiated, aligns
                        with state and national
                        computer science standards, and is continually updated to reflect changes in computer science. Since
                        computer science is more than just coding, Codelicious courses include coding, unplugged, digital
                        citizenship, and STEM career lessons as well as hardware integrations.</p>
                </div>
            </div>
        </div>
