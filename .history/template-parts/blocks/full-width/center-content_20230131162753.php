...
$heading_color = get_field('act_center_content_heading_color');
$font_color = get_field('acf_center_content_font_color');
$acf_center__content = get_field('acf_center__content');
$acf_center_content_button = get_field('acf_center_content_button');



// echo $act_center_content_heading_color;
// exit;
            ...
            <div class="col-lg-9">
                <?php if ($acf_center__content) : foreach ($acf_center__content as $center__content) : ?>
                        <div class="center-content-module__column">
                            <h3 class="center-heading" style="color: <?php echo $heading_color; ?>">
                            ...
                            <?php if (!empty($acf_center_content_button)) : ?>
                                <div class="center-content-module__btn">
                                    <a href="<?php echo $acf_center_content_button['url']; ?>" class="whitebtn orange-btn"><?php echo $acf_center_content_button['title']; ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                <?php endforeach;
