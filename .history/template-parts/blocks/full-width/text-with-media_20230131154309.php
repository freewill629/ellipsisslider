  ...
  <div class="page-container box-padding">
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-9">
        ...
        <div class="text-with-media__descreption color-black">
          <?php echo $media_text; ?>
        ...
        <?php if ($text_with_media_button_option == 'one') { ?>
          <div class="text-with-media__btn">
            <a href="<?php echo $text_with_media_button_one['url']; ?> " class="<?php $button_color ?>whitebtn"> <?php echo $text_with_media_button_one['title']; ?></a>
          </div>
        <?php } ?>
