      ...
      <div class="col-lg-9">
        ...
        <?php if ($text_with_media_button_option == 'one') { ?>
          <div class="text-with-media__btn">
            <a href="<?php echo $text_with_media_button_one['link']; ?> " class="whitebtn"> <?php echo $text_with_media_button_one['title']; ?></a>
          </div>
        <?php } ?>
        ...
        <?php if ($text_with_media_button_option == 'two') { ?>
          <div class="text-with-media__btn">
            <a href="<?php echo $text_with_media_button_one['link']; ?> " class="whitebtn"> <?php echo $text_with_media_button_one['title']; ?></a>
            <a href="<?php echo $text_with_media_button_two['link']; ?> " class="whitebtn"> <?php echo $text_with_media_button_two['title']; ?></a>
          </div>
        <?php } ?>
      </div>
    </div>
